...
const AuctionPanel = () =>{
    return(
        <TabContentWrapper>
          <InputWrapper>
              ...
              <FormControl fullWidth >
                ...
                <InputLabel
                  ...
                  htmlFor="description">Add Users</InputLabel>
            </FormControl>
            </FormControlWrapper>
          </InputWrapper>
          <InputWrapper>
            <ParaTag> Royalty % Split </ParaTag>
              <FormControlWrapper>
                <FormControl fullWidth>
                  <Input
                      style={{borderBottomColor:'#6F6F6F', color: '#6F6F6F'}}
                      id="description" type="text"  />
                  <InputLabel style={{fontSize:'14px', color: '#6F6F6F'}} htmlFor="description">Text</InputLabel>
                </FormControl>
              </FormControlWrapper>
          </InputWrapper>
          <InputWrapper>
            <ParaTag> Royalty Split Term </ParaTag>
              <FormControlWrapper>
                <FormControl fullWidth>
                  <Input
                      style={{borderBottomColor:'#6F6F6F', color: '#6F6F6F'}}
          ...
          <InputWrapper>
            <ParaTag> ETH Token Address</ParaTag>
              <FormControlWrapper>
                <FormControl fullWidth>
                  <Input
                      style={{borderBottomColor:'#6F6F6F', color: '#6F6F6F'}}
                      id="description" type="text"  />
                  <InputLabel style={{fontSize:'14px', color: '#6F6F6F'}} htmlFor="description">Enter User's ETH Token address</InputLabel>
                </FormControl>
              </FormControlWrapper>
          </InputWrapper>
          <InputWrapper>  
              <ParaTag> Select Role </ParaTag>
            <FormControlWrapper>
              <FormControl fullWidth>
              <InputLabel style={{fontSize:'14px', color: '#6F6F6F'}} id="category">Select Role</InputLabel>
