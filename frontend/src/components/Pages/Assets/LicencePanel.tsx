        ...
        <TabContentWrapper>
              ...
              <FormControlWrapper>
                <FormControl fullWidth>
                  <Input
                      style={{borderBottomColor:'#6F6F6F', color: '#6F6F6F'}}
                      id="description" type="text"  />
                  <InputLabel style={{fontSize:'14px', top:'-10px',left:'-14px', color: '#6F6F6F'}} htmlFor="description">Currency</InputLabel>
                </FormControl>
              </FormControlWrapper>
          </InputWrapper>
          <InputWrapper>
              ...
              <FormControlWrapper>
                <FormControl fullWidth>
                  <Input
                      style={{borderBottomColor:'#6F6F6F', color: '#6F6F6F'}}
                      id="description" type="text"  />
                  <InputLabel style={{fontSize:'14px', top:'-10px',left:'-14px', color: '#6F6F6F'}} htmlFor="description">Licence Period</InputLabel>
                </FormControl>
              </FormControlWrapper>
          </InputWrapper>
          <InputWrapper>
              ...
              <FormControlWrapper>
                <FormControl fullWidth>
                  <Input
                      style={{borderBottomColor:'#6F6F6F', color: '#6F6F6F'}}
                      id="description" type="text"  />
                  <InputLabel style={{fontSize:'14px', top:'-10px',left:'-14px', color: '#6F6F6F'}} htmlFor="description">Licence Teritory</InputLabel>
                </FormControl>
              </FormControlWrapper>
          </InputWrapper>
          <InputWrapper>
              ...
              <FormControlWrapper>
                <FormControl fullWidth>
                  <Input
                      style={{borderBottomColor:'#6F6F6F', color: '#6F6F6F'}}
                      id="description" type="text"  />
                  <InputLabel style={{fontSize:'14px', top:'-10px',left:'-14px', color: '#6F6F6F'}} htmlFor="description">Licence Advance</InputLabel>
                </FormControl>
              </FormControlWrapper>
          </InputWrapper>
          <InputWrapper>
              ...
              <FormControlWrapper>
                <FormControl fullWidth>
                  <Input
                      style={{borderBottomColor:'#6F6F6F', color: '#6F6F6F'}}
                      id="description" type="text"  />
                  <InputLabel style={{fontSize:'14px', top:'-10px',left:'-14px', color: '#6F6F6F'}} htmlFor="description">Usage Right</InputLabel>
                </FormControl>
              </FormControlWrapper>
          </InputWrapper>
              ...
              <FormControlWrapper>
                <FormControl fullWidth>
                  <Input
                      style={{borderBottomColor:'#6F6F6F', color: '#6F6F6F'}}
                      id="description" type="text"  />
                  <InputLabel style={{fontSize:'14px', top:'-10px',left:'-14px', color: '#6F6F6F'}} htmlFor="description">Add Content</InputLabel>
                </FormControl>
              </FormControlWrapper>
          </InputWrapper>
          ...
          <InputWrapper>
            ...
            <FormControl fullWidth>
                ...
                <InputLabel style={{fontSize:'14px', top:'-10px',left:'-14px', color: '#6F6F6F'}} htmlFor="description">Creator's Term URL</InputLabel>
            </FormControl>
            </FormControlWrapper>
          </InputWrapper>
          <InputWrapper>
