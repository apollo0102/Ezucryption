...
const FixedSales = () =>{
    return(
        <TabContentWrapper>
            <InputWrapper>
              <ParaTag> Fixed Sale Price</ParaTag>
              <FormControlWrapper>
              <FormControl fullWidth >
                ...
                <InputLabel
                  ...
                  htmlFor="description">Fixed Sale Price</InputLabel>
            </FormControl>
            </FormControlWrapper>
            </InputWrapper>

          <InputWrapper>  
              <ParaTag style={{marginTop:'12px'}}> Currenncy </ParaTag>
            <FormControlWrapper>
              <FormControl variant="standard" fullWidth>
              <InputLabel style={{fontSize:'14px', color: '#6F6F6F'}} id="category">Select Currency</InputLabel>
              ...
              <FormControlWrapper>
                <FormControl fullWidth>
                  <Input
                      style={{borderBottomColor:'#6F6F6F', color: '#6F6F6F'}}
                      id="description" type="text"  />
                  <InputLabel style={{fontSize:'14px', top:'-10px',left:'-14px', color: '#6F6F6F'}} htmlFor="description">Additional Content</InputLabel>
                </FormControl>
              </FormControlWrapper>
          </InputWrapper>
            
          <InputWrapper> 
            <ParaTag> Instant Sale </ParaTag>
              <FormControlWrapper>
                <Switch />
              </ FormControlWrapper>
          </InputWrapper>
