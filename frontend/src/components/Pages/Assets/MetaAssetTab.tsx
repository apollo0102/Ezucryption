...
import CategoryDetails from './MetaCategoryDetailsPanel';
import MetaCopyrightPanel from './MetaCopyrightPanel';
...
const GenericTab :NextPage<GenericTabProps> = ({firstTitle, secondTitle, thirdTitle})  =>{
