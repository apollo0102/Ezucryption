  ...
  return (
    <>
      ...
      <Grid container>
        ...
        <Grid sm={6} mt={[14, 0]}>
          ...
          <Box>
            ...
            <Typography
              className="g-font-family-kern"
              sx={{ fontSize: 14, lineHeight: "28px" }}
              mb={8}
            >
              This NFT includes an original authentic digital replica of the
              work in a high res JPG format.
            </Typography>
          ...
          <Box display="flex" flexDirection="column" alignItems="end" mt={10}>
            <ActionButton
              className="g-font-family-kern g-font-medium"
              style={{ height: 48 }}
              display="flex"
            ...
            <Box
              ...
              mt={1.2}
            >
              <Typography className="g-font-family-kern" sx={{ fontSize: 10 }}>
                SERVICE FEE
              </Typography>
      ...
      <Box pt={1.7} mt={16} sx={{ borderTop: "1px solid" }}>
        ...
        <TabPanel value={selectedTab} index={0} panelName="fixed-sale">
          1
        </TabPanel>

        <TabPanel value={selectedTab} index={1} panelName="fixed-sale">
          2
        </TabPanel>

        <TabPanel value={selectedTab} index={2} panelName="fixed-sale">
          3
        </TabPanel>

        <TabPanel value={selectedTab} index={3} panelName="fixed-sale">
          4
        </TabPanel>
      </Box>
    </>
